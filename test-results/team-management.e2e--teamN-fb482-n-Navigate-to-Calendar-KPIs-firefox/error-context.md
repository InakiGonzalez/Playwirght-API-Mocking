...
```
Error: locator.click: Error: strict mode violation: getByText('Usuario de Prueba') resolved to 4 elements:
    ...
    2) <span class="text-black">Usuario de Prueba</span> aka getByText('Usuario de Prueba').nth(1)
    3) <span class="text-black">Usuario de Prueba</span> aka getByText('Usuario de Prueba').nth(2)
    4) <span class="text-black">Usuario de Prueba</span> aka getByText('Usuario de Prueba').nth(3)
